...
public class Menu { // This is the main menu interface.
    ...
    public static void eventType() {
        ...
        do {
            ...
            try  // this will try to take an integer input if the input is a non integer it will show an error and got to the catch lower down and request the data be input again
            {
                iInput = SC.nextInt();
            }
            catch (Exception e){
